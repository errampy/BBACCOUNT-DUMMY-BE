...
from user_management import service as service
from workflow import ms_crud as workflow

from marketingand_customer_relations_department import ms_crud as marketingand_customer_relations_department
from riskand_compliance_department import ms_crud as riskand_compliance_department
from operations_department import ms_crud as operations_department
from itand_misdepartment import ms_crud as itand_misdepartment
from human_resources_department import ms_crud as human_resources_department
from aging_reports import ms_crud as aging_reports
from administration_department import ms_crud as administration_department
from financial_department import ms_crud as financial_department
...
def so_registration(register):
    try:
        ...
        service_api_url = 'http://127.0.0.1:9001/register-serviceplan/'
        headers = {
...
# service list
module_lists=[microservices,service,workflow]

app_module_list=[marketingand_customer_relations_department,riskand_compliance_department,operations_department,itand_misdepartment,human_resources_department,aging_reports,administration_department,financial_department]

all_module_list = [module_lists,app_module_list] # here combining all the module here
